      ...
      if (mysqli_num_rows($result) > 0){
        while ($row = mysqli_fetch_assoc($result)){
          ...
          <div style="width: 400px; height: 460px; float: left; margin: 30px; padding-top: 20px; margin-top: 20px; background-color: #B2BD8C; justify-content: center;">
              <img src="img/products.jpg" alt="about-1" style="width: 340px; height: 300px; background-color: white; margin-top: 10px; padding: 4px; margin-left: 28px; margin-top: 10px;">
