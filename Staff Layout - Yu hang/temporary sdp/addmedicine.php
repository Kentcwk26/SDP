...
<?php
    ...
    ?>
    <br>
    <b><p style="text-align:center;"><u>Add Medicine</u></p></b>
    ...
    <br>
    <br>
    <center><div id="my-button"><a href="WHmanagemedicine.php">Back</a></div>  <div id="my-button"><a href="#">Add</a></div></center>
</body>
</html>