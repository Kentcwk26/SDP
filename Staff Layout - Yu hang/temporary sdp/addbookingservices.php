...
<?php
    ...
    ?>
    <br>
    <b><p style="text-align:center;"><u>Add Booking Services</u></p></b>
    <br>
    <br>
    <center><label for="BookingService" style="color: white">Booking Service:</label>
        <select style="width:700px; height: 30px;">
    ...
    <br>
    <br>
    <center><div id="my-button"><a href="managebookingservice.php">Back</a></div>  <div id="my-button"><a href="#">Complete</a></div></center>
</body>
</html>