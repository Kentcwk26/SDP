...
<?php
    ...
    ?>
    <br>
    <b><p style="text-align:center;"><u>Edit Medicine</u></p></b>
    <br>
    <center><select style="width: 780px; height: 40px;">
		<option value="">-Please choose the medicine that need to edit-</option>
    ...
    <br>
    <br>
    <label for="user-input" style="color: white">Staff ID:</label> <input type="text" id="user-input" name="user-input">
    </center>
    <br>
    <br>
    <center><div id="my-button"><a href="WHmanagemedicine.php">Cancel</a></div>  <div id="my-button"><a href="#">Edit</a></div></center>
</body>
</html>