...
<?php
    ...
    ?>
    <br>
    <b><p style="text-align:center;"><u>Edit Product</u></p></b>
    <br>
    <center><select style="width: 780px; height: 40px;">
		<option value="">-Please choose the product that need to edit-</option>
    ...
    <br>
    <br>
    <center><div id="my-button"><a href="WHmanageproducts.php">Cancel</a></div>  <div id="my-button"><a href="#">Edit</a></div></center>
</body>
</html>